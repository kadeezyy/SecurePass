...
public class Organization implements Serializable {
    ...
    private final Float annualTurnover; //Поле не может быть null, Значение поля должно быть больше 0
    private final String fullName; //Значение этого поля должно быть уникальным, Поле не может быть null
    ...
    public String toString() {
        return String.format("Идентификатор: %d%n" +
                ...
                fullName, employeesCount, type, getPostalAddress(), getOwner().getName());
    }
